...
<body>
            ...
            <div class="services-grid">
                ...
                <i class="<?php echo $package['service_name'] === 'Baju Pengantin' ? 'fas fa-wedding-dress' : 'fas fa-brush'; ?>"></i>
                                    ...
                                    <div class="package-content">
                                        ...
                                        <p class="package-includes">
                                            <?php echo htmlspecialchars(substr($package['includes'], 0, 80)) . '...'; ?></p>
                                        <a href="package_detail.php?id=<?php echo $package['id']; ?>" class="btn">Lihat
                                            Detail</a>
                                    </div>
                                </div>
                            <?php endforeach; ?>
    ...
    <section id="gallery" class="section" style="background: #f8f9fa;">
        <div class="container">
            ...
            <p class="section-subtitle">Lihat hasil karya terbaik kami dalam koleksi baju pengantin dan makeup
                profesional</p>
                    ...
                    <div class="gallery-item">
                        <?php if ($item['image'] && file_exists('uploads/gallery/' . $item['image'])): ?>
                            <div class="gallery-image"
                                style="background-image: url('uploads/gallery/<?php echo htmlspecialchars($item['image']); ?>'); background-size: cover; background-position: center; position: relative;">
                                <div class="gallery-badge"><?php echo htmlspecialchars($item['service_name']); ?></div>
                                <!-- Optional overlay icon -->
                                <div
                                    style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: rgba(0,0,0,0.5); color: white; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; opacity: 0; transition: opacity 0.3s;">
                                    <i
                                        class="<?php echo $item['service_name'] == 'Baju Pengantin' ? 'fas fa-wedding-dress' : 'fas fa-brush'; ?>"></i>
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="gallery-image">
