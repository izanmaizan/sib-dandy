...
$stmt = $db->prepare("SELECT p.*, p.service_type as service_name
                     FROM packages p 
...
$stmt = $db->prepare("SELECT u.full_name, b.special_request, b.created_at 
                     FROM bookings b 
...
<body>
    ...
    <a href="packages.php?type=<?php echo $package['service_name'] === 'Baju Pengantin' ? 'dress' : 'makeup'; ?>">
    ...
    <span class="current"><?php echo htmlspecialchars($package['name']); ?></span>
            ...
            <!-- Package Hero -->
<div class="package-hero" <?php if ($package['image'] && file_exists('uploads/packages/' . $package['image'])): ?>
    ...
    <div class="hero-content">
        <?php if ($package['service_name']): ?>
            <div class="package-category">
                <i class="<?php echo $package['service_icon']; ?>"></i> <?php echo htmlspecialchars($package['service_name']); ?>
            </div>
        <?php endif; ?>
                ...
                <div class="details-main">
                    ...
                    <section style="margin-top: 3rem;">
                        ...
                        <div style="background: #f8f9fa; padding: 2rem; border-radius: 15px; line-height: 1.8;">
                            ...
                            <?php else: ?>
                                <p>Paket wedding yang dirancang khusus untuk membuat hari spesial Anda menjadi tak terlupakan. Dengan layanan profesional dan berkualitas tinggi, kami berkomitmen memberikan pengalaman terbaik untuk pernikahan impian Anda.</p>
                            <?php endif; ?>
                            ...
                            <div style="margin-top: 2rem; padding-top: 2rem; border-top: 1px solid #dee2e6;">
                                ...
                                <ul style="list-style: none; padding: 0;">
                                    <li style="margin-bottom: 0.5rem;"><i class="fas fa-star" style="color: #ffa500; margin-right: 0.5rem;"></i> Tim profesional berpengalaman</li>
                                    <li style="margin-bottom: 0.5rem;"><i class="fas fa-star" style="color: #ffa500; margin-right: 0.5rem;"></i> Kualitas makeup dan dress terbaik</li>
                                    <li style="margin-bottom: 0.5rem;"><i class="fas fa-star" style="color: #ffa500; margin-right: 0.5rem;"></i> Service excellent dari awal hingga akhir</li>
                                    <li style="margin-bottom: 0.5rem;"><i class="fas fa-star" style="color: #ffa500; margin-right: 0.5rem;"></i> Harga terjangkau dengan kualitas premium</li>
                                </ul>
                            </div>
                        </div>
                    </section>
    ...
    <div class="info-item">
        ...
        <span class="info-value"><?php echo $stats['total_bookings']; ?>x</span>
                    ...
                    <div class="action-card">
                        ...
                        <p>Jangan sampai kehabisan slot di hari spesial Anda. Book sekarang dan dapatkan pelayanan terbaik!</p>
                    ...
                    <div class="info-card">
                        ...
                        <p style="color: #666; margin-bottom: 1rem;">Tim kami siap membantu Anda memilih paket yang tepat.</p>
                        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                            ...
                            <a href="https://wa.me/628123456789" style="color: #ff6b6b; text-decoration: none;" target="_blank">
    ...
    <div style="background: white; border-radius: 20px; padding: 2.5rem; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 2rem; margin-top: 1.5rem;">
            ...
            <div style="position: relative; border-radius: 15px; overflow: hidden; box-shadow: 0 10px 25px rgba(0,0,0,0.1);">
                ...
                <!-- Image Overlay Info -->
                <div style="position: absolute; bottom: 0; left: 0; right: 0; background: linear-gradient(transparent, rgba(0,0,0,0.7)); color: white; padding: 2rem;">
                    <h3 style="font-size: 1.5rem; margin-bottom: 0.5rem;"><?php echo htmlspecialchars($package['name']); ?></h3>
                    <p style="opacity: 0.9;">Klik untuk memperbesar gambar</p>
                </div>
                
                <!-- Zoom Icon -->
                <div style="position: absolute; top: 1rem; right: 1rem; background: rgba(255,255,255,0.9); color: #333; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer;" onclick="openImageModal('uploads/packages/<?php echo htmlspecialchars($package['image']); ?>')">
            ...
            <div style="background: #f8f9fa; padding: 1.5rem; border-radius: 10px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem;">
                    ...
                    <div>
                        ...
                        <span style="color: #666;"><?php echo htmlspecialchars($package['service_name']); ?></span>
                    </div>
                    <div>
                        <strong>Harga:</strong><br>
                        <span style="color: #ff6b6b; font-weight: bold;"><?php echo formatRupiah($package['price']); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<div class="related-card">
    ...
    <?php if ($related['image'] && file_exists('uploads/packages/' . $related['image'])): ?>
        <div class="related-image" style="background-image: url('uploads/packages/<?php echo htmlspecialchars($related['image']); ?>'); background-size: cover; background-position: center; position: relative;">
            <!-- Overlay icon -->
            <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background: rgba(255,255,255,0.9); color: #ff6b6b; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.5rem;">
                <i class="<?php echo $related['service_name'] === 'Baju Pengantin' ? 'fas fa-wedding-dress' : 'fas fa-brush'; ?>"></i>
            </div>
        </div>
    <?php else: ?>
    ...
    <div class="related-content">
        ...
        <div class="related-category"><?php echo htmlspecialchars($related['service_name']); ?></div>
        ...
        <a href="package_detail.php?id=<?php echo $related['id']; ?>" class="btn" style="background: #ff6b6b; color: white; font-size: 0.9rem; padding: 8px 16px;">
...
<?php endif; ?>
            ...
            <!-- Call to Action -->
            <section style="background: linear-gradient(135deg, #ff6b6b, #ffa500); color: white; padding: 3rem; border-radius: 20px; text-align: center; margin: 3rem 0;">
                ...
                <p style="font-size: 1.2rem; opacity: 0.9; margin-bottom: 2rem; max-width: 600px; margin-left: auto; margin-right: auto;">
                    Jangan biarkan hari spesial Anda berlalu begitu saja. Percayakan kepada kami untuk memberikan pengalaman terbaik yang akan selalu Anda kenang selamanya.
                </p>
                <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
                    <?php if (isLoggedIn()): ?>
                        <a href="customer/booking_new.php?package=<?php echo $package['id']; ?>" class="btn" style="background: white; color: #ff6b6b; font-size: 1.1rem; padding: 15px 30px;">
                            <i class="fas fa-calendar-check"></i> Book Paket Ini
                        </a>
                    <?php else: ?>
                        <a href="login.php" class="btn" style="background: white; color: #ff6b6b; font-size: 1.1rem; padding: 15px 30px;">
                            <i class="fas fa-sign-in-alt"></i> Login untuk Book
                        </a>
                    <?php endif; ?>
                    <a href="https://wa.me/628123456789" class="btn btn-secondary" style="font-size: 1.1rem; padding: 15px 30px;" target="_blank">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; margin-bottom: 2rem; text-align: left;">
                <div>
                    ...
                    <p style="opacity: 0.8; line-height: 1.6;">
                        Spesialis wedding organizer dan bridal makeup terpercaya. Memberikan layanan terbaik untuk mewujudkan pernikahan impian Anda.
                    </p>
                </div>
                <div>
    ...
    <script>
        ...
        document.querySelectorAll('.btn').forEach(btn => {
            btn.addEventListener('click', function() {
                if (this.href && !this.href.includes('tel:') && !this.href.includes('mailto:') && !this.href.includes('wa.me')) {
