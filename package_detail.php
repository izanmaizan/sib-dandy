                ...
                <div class="details-sidebar">
                    ...
                    <div class="info-card">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                            <a href="tel:+6285182480417 " style="color: #ff6b6b; text-decoration: none;">
                            ...
                            <a href="https://wa.me/6285182480417 " style="color: #ff6b6b; text-decoration: none;"
                                target="_blank">
                ...
                <div>
                    ...
                    <ul style="list-style: none; opacity: 0.8;">
                        <li style="margin-bottom: 0.5rem;">
                            <i class="fas fa-phone"></i> +62 851-8248-0417
                        </li>
                        <li style="margin-bottom: 0.5rem;">
                            <i class="fas fa-envelope"></i> info@dandygallery.com
                        </li>
                        <li style="margin-bottom: 0.5rem;">
                            <i class="fas fa-map-marker-alt"></i> Bungus Sel., Kec. Bungus Tlk. Kabung, Kota Padang,
                            Sumatera Barat
                        </li>
                    </ul>
                </div>
