                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small
                                    style="color: #666;"><?php echo htmlspecialchars($booking['service_name']); ?></small>
                            </td>
                            <td>
                            ...
                            <td>
                                <span
                                    class="status <?php echo getAdminDashboardStatus($booking) === 'Lunas' ? 'completed' : ($booking['total_paid'] >= $booking['down_payment'] ? 'paid' : $booking['status']); ?>">
