...
$customer_count = count(array_filter($users, function ($u) {
            ...
            <form method="GET" class="filter-form">
                ...
                <div class="form-group">
                    ...
                    <select id="role" name="role">
                        ...
                        <option value="customer" <?php echo $role_filter === 'customer' ? 'selected' : ''; ?>>Customer
                        </option>
                ...
                <div class="user-card">
                    ...
                    <div class="user-details">
                        ...
                        <div class="detail-item">
                            ...
                            <span>Booking terakhir:
                                <?php echo date('d/m/Y', strtotime($user['last_booking'])); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
