    ...
    <main class="main-content">
        ...
        <div class="packages-grid">
            ...
            <div class="package-card">
                ...
                <?php else: ?>
                <div
                    style="height: 200px; background: #f8f9fa; display: flex; align-items: center; justify-content: center; color: #666;">
                ...
                <div class="package-body">
                    ...
                    <div class="package-meta">
                        <span><i class="fas fa-calendar"></i>
                            <?php echo date('d/m/Y', strtotime($package['created_at'])); ?></span>
                        <?php if ($package['size_available']): ?>
                        <span><i class="fas fa-ruler"></i>
                            <?php echo htmlspecialchars($package['size_available']); ?></span>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="package-actions">
                        <button type="button" class="btn btn-sm"
                            onclick="openEditModal(<?php echo htmlspecialchars(json_encode($package)); ?>)">
        ...
        <div class="card">
            <div class="card-body" style="text-align: center; padding: 3rem;">
                ...
                <p style="color: #666; margin-bottom: 2rem;">Mulai tambahkan paket baju pengantin dan makeup untuk
                    customer Anda.</p>
                <button type="button" class="btn" onclick="openAddModal()">
                ...
                <form method="POST" id="packageForm" enctype="multipart/form-data">
                    ...
                    <div id="dressFields" class="service-specific">
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="color_available" name="color_available"
                                    placeholder="Contoh: White,Ivory,Champagne">
                                <small style="color: #666;">Pisahkan dengan koma</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="includes" name="includes" rows="4"
                            placeholder="Pisahkan dengan koma, contoh: Gaun pengantin, Makeup, Hairdo, Aksesoris"></textarea>
                    </div>
