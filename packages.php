    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="service-tabs">
                ...
                <a href="packages.php?type=dress" class="service-tab <?php echo $service_filter === 'dress' ? 'active' : ''; ?>">
                    <i class="fas fa-tshirt"></i> Sewa Baju Pengantin
                </a>
                <a href="packages.php?type=makeup" class="service-tab <?php echo $service_filter === 'makeup' ? 'active' : ''; ?>">
...
<i class="<?php echo $service_icon; ?>"></i> <?php echo htmlspecialchars($package['service_name']); ?></div>
    ...
    <?php endif; ?>
                                ...
                                <div class="package-content">
                                    ...
                                    <div class="package-actions">
                                        <?php if (isLoggedIn()): ?>
                                            <a href="customer/booking_new.php?package=<?php echo $package['id']; ?>" class="btn-book">
...
<?php if ($package['image'] && file_exists('uploads/packages/' . $package['image'])): ?>
    <div class="package-image" style="background-image: url('uploads/packages/<?php echo htmlspecialchars($package['image']); ?>'); background-size: cover; background-position: center; position: relative;">
        <div class="package-badge"><?php $service_icon = getServiceIcon($package['service_name']); ?>
<i class="<?php echo $service_icon; ?>"></i> <?php echo htmlspecialchars($package['service_name']); ?></div>
        <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.3);"></div>
    </div>
<?php else: ?>
...
<?php endif; ?>
            ...
            <!-- Call to Action -->
            <div style="text-align: center; margin-top: 4rem; padding: 3rem; background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
    ...
    <footer style="background: #333; color: white; text-align: center; padding: 3rem 0; margin-top: 4rem;">
        <div class="container">
            ...
            <p style="margin-top: 0.5rem; opacity: 0.8;">Sistem Informasi Booking Sewa Baju Pengantin & Jasa Makeup Profesional</p>
        </div>
    </footer>
